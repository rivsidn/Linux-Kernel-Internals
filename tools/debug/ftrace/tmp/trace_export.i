...
# 7 "kernel/trace/trace_export.c" 2
...
# 8 "kernel/trace/trace_export.c" 2
...
extern struct hlist_node *seq_hlist_next_rcu(void *v,
         ...
         loff_t *ppos);
# 9 "kernel/trace/trace_export.c" 2
...
# 11 "include/linux/percpu_counter.h" 2
...
# 14 "include/linux/percpu_counter.h" 2
...
# 10 "kernel/trace/trace_export.c" 2
...
# 11 "kernel/trace/trace_export.c" 2
...
# 12 "kernel/trace/trace_export.c" 2




# 1 "kernel/trace/trace_output.h" 1
...
# 5 "kernel/trace/trace_output.h" 2
...
# 6 "kernel/trace/trace_output.h" 2
...
# 17 "kernel/trace/trace_export.c" 2
# 63 "kernel/trace/trace_export.c"
# 1 "kernel/trace/trace_entries.h" 1
# 58 "kernel/trace/trace_entries.h"
struct
# 68 "kernel/trace/trace_entries.h"
 ____ftrace_function
# 58 "kernel/trace/trace_entries.h"
 { unsigned long ip; unsigned long parent_ip; }; static void __attribute__((unused))
# 68 "kernel/trace/trace_entries.h"
 ____ftrace_check_function
# 58 "kernel/trace/trace_entries.h"
 (void) { struct
# 68 "kernel/trace/trace_entries.h"
 ____ftrace_function
# 58 "kernel/trace/trace_entries.h"
 *__entry = ((void *)0); printk(" %lx <-- %lx", __entry->ip, __entry->parent_ip); }
# 68 "kernel/trace/trace_entries.h"
 ;
...
struct
# 82 "kernel/trace/trace_entries.h"
 ____ftrace_funcgraph_entry
# 71 "kernel/trace/trace_entries.h"
 { unsigned long func; int depth; }; static void __attribute__((unused))
# 82 "kernel/trace/trace_entries.h"
 ____ftrace_check_funcgraph_entry
# 71 "kernel/trace/trace_entries.h"
 (void) { struct
# 82 "kernel/trace/trace_entries.h"
 ____ftrace_funcgraph_entry
# 71 "kernel/trace/trace_entries.h"
 *__entry = ((void *)0); printk("--> %lx (%d)", __entry->func, __entry->depth); }
# 82 "kernel/trace/trace_entries.h"
 ;
...
struct
# 102 "kernel/trace/trace_entries.h"
 ____ftrace_funcgraph_exit
# 85 "kernel/trace/trace_entries.h"
 { unsigned long func; unsigned long long calltime; unsigned long long rettime; unsigned long overrun; int depth; }; static void __attribute__((unused))
# 102 "kernel/trace/trace_entries.h"
 ____ftrace_check_funcgraph_exit
# 85 "kernel/trace/trace_entries.h"
 (void) { struct
# 102 "kernel/trace/trace_entries.h"
 ____ftrace_funcgraph_exit
# 85 "kernel/trace/trace_entries.h"
 *__entry = ((void *)0); printk("<-- %lx (%d) (start: %llx  end: %llx) over: %d", __entry->func, __entry->depth, __entry->calltime, __entry->rettime, __entry->depth); }
# 102 "kernel/trace/trace_entries.h"
 ;
# 119 "kernel/trace/trace_entries.h"
struct
# 132 "kernel/trace/trace_entries.h"
 ____ftrace_context_switch
# 119 "kernel/trace/trace_entries.h"
 { unsigned int prev_pid; unsigned char prev_prio; unsigned char prev_state; unsigned int next_pid; unsigned char next_prio; unsigned char next_state; unsigned int
# 117 "kernel/trace/trace_entries.h"
                        next_cpu

 ; }; static void __attribute__((unused))
# 132 "kernel/trace/trace_entries.h"
 ____ftrace_check_context_switch
# 119 "kernel/trace/trace_entries.h"
 (void) { struct
# 132 "kernel/trace/trace_entries.h"
 ____ftrace_context_switch
# 119 "kernel/trace/trace_entries.h"
 *__entry = ((void *)0); printk("%u:%u:%u  ==> %u:%u:%u [%03u]", __entry->prev_pid, __entry->prev_prio, __entry->prev_state, __entry->next_pid, __entry->next_prio, __entry->next_state, __entry->next_cpu); }
# 132 "kernel/trace/trace_entries.h"
 ;
...
# 168 "kernel/trace/trace_entries.h"
 ____ftrace_special
# 156 "kernel/trace/trace_entries.h"
 { unsigned long arg1; unsigned long arg2; unsigned long arg3; }; static void __attribute__((unused))
# 168 "kernel/trace/trace_entries.h"
 ____ftrace_check_special
# 156 "kernel/trace/trace_entries.h"
 (void) { struct
# 168 "kernel/trace/trace_entries.h"
 ____ftrace_special
# 156 "kernel/trace/trace_entries.h"
 *__entry = ((void *)0); printk("(%08lx) (%08lx) (%08lx)", __entry->arg1, __entry->arg2, __entry->arg3); }
# 168 "kernel/trace/trace_entries.h"
 ;
...
struct
# 189 "kernel/trace/trace_entries.h"
 ____ftrace_kernel_stack
# 176 "kernel/trace/trace_entries.h"
 { unsigned long caller[8]; }; static void __attribute__((unused))
# 189 "kernel/trace/trace_entries.h"
 ____ftrace_check_kernel_stack
# 176 "kernel/trace/trace_entries.h"
 (void) { struct
# 189 "kernel/trace/trace_entries.h"
 ____ftrace_kernel_stack
# 176 "kernel/trace/trace_entries.h"
 *__entry = ((void *)0); printk("\t=> (%08lx)\n\t=> (%08lx)\n\t=> (%08lx)\n\t=> (%08lx)\n" "\t=> (%08lx)\n\t=> (%08lx)\n\t=> (%08lx)\n\t=> (%08lx)\n", __entry->caller[0], __entry->caller[1], __entry->caller[2], __entry->caller[3], __entry->caller[4], __entry->caller[5], __entry->caller[6], __entry->caller[7]); }
# 189 "kernel/trace/trace_entries.h"
 ;

struct
# 205 "kernel/trace/trace_entries.h"
 ____ftrace_user_stack
# 191 "kernel/trace/trace_entries.h"
 { unsigned int tgid; unsigned long caller[8]; }; static void __attribute__((unused))
# 205 "kernel/trace/trace_entries.h"
 ____ftrace_check_user_stack
# 191 "kernel/trace/trace_entries.h"
 (void) { struct
# 205 "kernel/trace/trace_entries.h"
 ____ftrace_user_stack
...
# 222 "kernel/trace/trace_entries.h"
 ____ftrace_bprint
# 210 "kernel/trace/trace_entries.h"
 { unsigned long ip; const char * fmt; u32 buf[]; }; static void __attribute__((unused))
# 222 "kernel/trace/trace_entries.h"
 ____ftrace_check_bprint
# 210 "kernel/trace/trace_entries.h"
 (void) { struct
# 222 "kernel/trace/trace_entries.h"
 ____ftrace_bprint
# 210 "kernel/trace/trace_entries.h"
 *__entry = ((void *)0); printk("%08lx fmt:%p", __entry->ip, __entry->fmt); }
# 222 "kernel/trace/trace_entries.h"
 ;
...
# 235 "kernel/trace/trace_entries.h"
 ____ftrace_print
# 224 "kernel/trace/trace_entries.h"
 { unsigned long ip; char buf[]; }; static void __attribute__((unused))
# 235 "kernel/trace/trace_entries.h"
 ____ftrace_check_print
# 224 "kernel/trace/trace_entries.h"
 (void) { struct
# 235 "kernel/trace/trace_entries.h"
 ____ftrace_print
# 224 "kernel/trace/trace_entries.h"
 *__entry = ((void *)0); printk("%08lx %s", __entry->ip, __entry->buf); }
# 235 "kernel/trace/trace_entries.h"
 ;

struct
# 254 "kernel/trace/trace_entries.h"
 ____ftrace_mmiotrace_rw
# 237 "kernel/trace/trace_entries.h"
 { resource_size_t phys; unsigned long value; unsigned long pc; int map_id; unsigned char opcode; unsigned char width; }; static void __attribute__((unused))
# 254 "kernel/trace/trace_entries.h"
 ____ftrace_check_mmiotrace_rw
# 237 "kernel/trace/trace_entries.h"
 (void) { struct
# 254 "kernel/trace/trace_entries.h"
 ____ftrace_mmiotrace_rw
# 237 "kernel/trace/trace_entries.h"
 *__entry = ((void *)0); printk("%lx %lx %lx %d %x %x", (unsigned long)__entry->phys, __entry->value, __entry->pc, __entry->map_id, __entry->opcode, __entry->width); }
# 254 "kernel/trace/trace_entries.h"
 ;

struct
# 272 "kernel/trace/trace_entries.h"
 ____ftrace_mmiotrace_map
# 256 "kernel/trace/trace_entries.h"
 { resource_size_t phys; unsigned long virt; unsigned long len; int map_id; unsigned char opcode; }; static void __attribute__((unused))
# 272 "kernel/trace/trace_entries.h"
 ____ftrace_check_mmiotrace_map
# 256 "kernel/trace/trace_entries.h"
 (void) { struct
# 272 "kernel/trace/trace_entries.h"
 ____ftrace_mmiotrace_map
# 256 "kernel/trace/trace_entries.h"
 *__entry = ((void *)0); printk("%lx %lx %lx %d %x", (unsigned long)__entry->phys, __entry->virt, __entry->len, __entry->map_id, __entry->opcode); }
# 272 "kernel/trace/trace_entries.h"
 ;

struct
# 285 "kernel/trace/trace_entries.h"
 ____ftrace_boot_call
# 274 "kernel/trace/trace_entries.h"
 { pid_t caller; char func[(sizeof("%s+%#lx/%#lx [%s]") + (128 - 1) + 2*(64*3/10) + ((64 - sizeof(unsigned long)) - 1) + 1)]; }; static void __attribute__((unused))
# 285 "kernel/trace/trace_entries.h"
 ____ftrace_check_boot_call
# 274 "kernel/trace/trace_entries.h"
 (void) { struct
# 285 "kernel/trace/trace_entries.h"
 ____ftrace_boot_call
# 274 "kernel/trace/trace_entries.h"
 *__entry = ((void *)0); printk("%d  %s", __entry->caller, __entry->func); }
# 285 "kernel/trace/trace_entries.h"
 ;
...
# 300 "kernel/trace/trace_entries.h"
 ____ftrace_boot_ret
# 287 "kernel/trace/trace_entries.h"
 { char func[(sizeof("%s+%#lx/%#lx [%s]") + (128 - 1) + 2*(64*3/10) + ((64 - sizeof(unsigned long)) - 1) + 1)]; int result; unsigned long duration; }; static void __attribute__((unused))
# 300 "kernel/trace/trace_entries.h"
 ____ftrace_check_boot_ret
# 287 "kernel/trace/trace_entries.h"
 (void) { struct
# 300 "kernel/trace/trace_entries.h"
 ____ftrace_boot_ret
# 287 "kernel/trace/trace_entries.h"
 *__entry = ((void *)0); printk("%s %d %lx", __entry->func, __entry->result, __entry->duration); }
# 300 "kernel/trace/trace_entries.h"
 ;
...
# 319 "kernel/trace/trace_entries.h"
 ____ftrace_branch
# 305 "kernel/trace/trace_entries.h"
 { unsigned int line; char func[30 +1]; char file[20 +1]; char correct; }; static void __attribute__((unused))
# 319 "kernel/trace/trace_entries.h"
 ____ftrace_check_branch
# 305 "kernel/trace/trace_entries.h"
 (void) { struct
# 319 "kernel/trace/trace_entries.h"
 ____ftrace_branch
# 305 "kernel/trace/trace_entries.h"
 *__entry = ((void *)0); printk("%u:%s:%s (%u)", __entry->line, __entry->func, __entry->file, __entry->correct); }
# 319 "kernel/trace/trace_entries.h"
 ;

struct
# 340 "kernel/trace/trace_entries.h"
 ____ftrace_kmem_alloc
# 321 "kernel/trace/trace_entries.h"
 { enum kmemtrace_type_id type_id; unsigned long call_site; const void * ptr; size_t bytes_req; size_t bytes_alloc; gfp_t gfp_flags; int node; }; static void __attribute__((unused))
# 340 "kernel/trace/trace_entries.h"
 ____ftrace_check_kmem_alloc
# 321 "kernel/trace/trace_entries.h"
 (void) { struct
# 340 "kernel/trace/trace_entries.h"
 ____ftrace_kmem_alloc
# 321 "kernel/trace/trace_entries.h"
 *__entry = ((void *)0); printk("type:%u call_site:%lx ptr:%p req:%zi alloc:%zi" " flags:%x node:%d", __entry->type_id, __entry->call_site, __entry->ptr, __entry->bytes_req, __entry->bytes_alloc, __entry->gfp_flags, __entry->node); }
# 340 "kernel/trace/trace_entries.h"
 ;

struct
# 354 "kernel/trace/trace_entries.h"
 ____ftrace_kmem_free
# 342 "kernel/trace/trace_entries.h"
 { enum kmemtrace_type_id type_id; unsigned long call_site; const void * ptr; }; static void __attribute__((unused))
# 354 "kernel/trace/trace_entries.h"
 ____ftrace_check_kmem_free
# 342 "kernel/trace/trace_entries.h"
 (void) { struct
# 354 "kernel/trace/trace_entries.h"
 ____ftrace_kmem_free
# 342 "kernel/trace/trace_entries.h"
 *__entry = ((void *)0); printk("type:%u call_site:%lx ptr:%p", __entry->type_id, __entry->call_site, __entry->ptr); }
# 354 "kernel/trace/trace_entries.h"
 ;

struct
# 370 "kernel/trace/trace_entries.h"
 ____ftrace_ksym_trace
# 356 "kernel/trace/trace_entries.h"
 { unsigned long ip; unsigned char type; char cmd[16]; unsigned long addr; }; static void __attribute__((unused))
# 370 "kernel/trace/trace_entries.h"
 ____ftrace_check_ksym_trace
# 356 "kernel/trace/trace_entries.h"
 (void) { struct
# 370 "kernel/trace/trace_entries.h"
 ____ftrace_ksym_trace
# 356 "kernel/trace/trace_entries.h"
 *__entry = ((void *)0); printk("ip: %pF type: %d ksym_name: %pS cmd: %s", (void *)__entry->ip, (unsigned int)__entry->type, (void *)__entry->addr, __entry->cmd); }
# 370 "kernel/trace/trace_entries.h"
 ;
# 64 "kernel/trace/trace_export.c" 2
# 126 "kernel/trace/trace_export.c"
# 1 "kernel/trace/trace_entries.h" 1
# 58 "kernel/trace/trace_entries.h"
int
# 68 "kernel/trace/trace_entries.h"
 ftrace_define_fields_function
# 58 "kernel/trace/trace_entries.h"
 (struct ftrace_event_call *event_call) { struct ftrace_entry field; int ret; ret = trace_define_field(event_call, "unsigned long", "ip", __builtin_offsetof(typeof(field),ip), sizeof(field.ip), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned long", "parent_ip", __builtin_offsetof(typeof(field),parent_ip), sizeof(field.parent_ip), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret;; return ret; }
# 68 "kernel/trace/trace_entries.h"
 ;
...
int
# 82 "kernel/trace/trace_entries.h"
 ftrace_define_fields_funcgraph_entry
# 71 "kernel/trace/trace_entries.h"
 (struct ftrace_event_call *event_call) { struct ftrace_graph_ent_entry field; int ret; ret = trace_define_field(event_call, "unsigned long", "func", __builtin_offsetof(typeof(field),graph_ent.func), sizeof(field.graph_ent.func), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "int", "depth", __builtin_offsetof(typeof(field),graph_ent.depth), sizeof(field.graph_ent.depth), (((int)(-1)) < 0), FILTER_OTHER); if (ret) return ret;; return ret; }
# 82 "kernel/trace/trace_entries.h"
 ;
...
int
# 102 "kernel/trace/trace_entries.h"
 ftrace_define_fields_funcgraph_exit
# 85 "kernel/trace/trace_entries.h"
 (struct ftrace_event_call *event_call) { struct ftrace_graph_ret_entry field; int ret; ret = trace_define_field(event_call, "unsigned long", "func", __builtin_offsetof(typeof(field),ret.func), sizeof(field.ret.func), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned long long", "calltime", __builtin_offsetof(typeof(field),ret.calltime), sizeof(field.ret.calltime), (((unsigned long long)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned long long", "rettime", __builtin_offsetof(typeof(field),ret.rettime), sizeof(field.ret.rettime), (((unsigned long long)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned long", "overrun", __builtin_offsetof(typeof(field),ret.overrun), sizeof(field.ret.overrun), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "int", "depth", __builtin_offsetof(typeof(field),ret.depth), sizeof(field.ret.depth), (((int)(-1)) < 0), FILTER_OTHER); if (ret) return ret;; return ret; }
# 102 "kernel/trace/trace_entries.h"
 ;
# 119 "kernel/trace/trace_entries.h"
int
# 132 "kernel/trace/trace_entries.h"
 ftrace_define_fields_context_switch
# 119 "kernel/trace/trace_entries.h"
 (struct ftrace_event_call *event_call) { struct ctx_switch_entry field; int ret; ret = trace_define_field(event_call, "unsigned int", "prev_pid", __builtin_offsetof(typeof(field),prev_pid), sizeof(field.prev_pid), (((unsigned int)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned char", "prev_prio", __builtin_offsetof(typeof(field),prev_prio), sizeof(field.prev_prio), (((unsigned char)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned char", "prev_state", __builtin_offsetof(typeof(field),prev_state), sizeof(field.prev_state), (((unsigned char)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned int", "next_pid", __builtin_offsetof(typeof(field),next_pid), sizeof(field.next_pid), (((unsigned int)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned char", "next_prio", __builtin_offsetof(typeof(field),next_prio), sizeof(field.next_prio), (((unsigned char)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned char", "next_state", __builtin_offsetof(typeof(field),next_state), sizeof(field.next_state), (((unsigned char)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned int", "next_cpu", __builtin_offsetof(typeof(field),
# 117 "kernel/trace/trace_entries.h"
                        next_cpu
...
# 117 "kernel/trace/trace_entries.h"
 ...
 ), (((unsigned int)(-1)) < 0), FILTER_OTHER); if (ret) return ret;; return ret; }
# 132 "kernel/trace/trace_entries.h"
 ;
...
int
# 168 "kernel/trace/trace_entries.h"
 ftrace_define_fields_special
# 156 "kernel/trace/trace_entries.h"
 (struct ftrace_event_call *event_call) { struct special_entry field; int ret; ret = trace_define_field(event_call, "unsigned long", "arg1", __builtin_offsetof(typeof(field),arg1), sizeof(field.arg1), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned long", "arg2", __builtin_offsetof(typeof(field),arg2), sizeof(field.arg2), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned long", "arg3", __builtin_offsetof(typeof(field),arg3), sizeof(field.arg3), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret;; return ret; }
# 168 "kernel/trace/trace_entries.h"
 ;
...
int
# 189 "kernel/trace/trace_entries.h"
 ftrace_define_fields_kernel_stack
# 176 "kernel/trace/trace_entries.h"
 (struct ftrace_event_call *event_call) { struct stack_entry field; int ret; ((void)(sizeof(struct { int:-!!(8 > 256); }))); ret = trace_define_field(event_call, "unsigned long" "[" "FTRACE_STACK_ENTRIES" "]", "caller", __builtin_offsetof(typeof(field),caller), sizeof(field.caller), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret;; return ret; }
# 189 "kernel/trace/trace_entries.h"
 ;

int
# 205 "kernel/trace/trace_entries.h"
 ftrace_define_fields_user_stack
# 191 "kernel/trace/trace_entries.h"
 (struct ftrace_event_call *event_call) { struct userstack_entry field; int ret; ret = trace_define_field(event_call, "unsigned int", "tgid", __builtin_offsetof(typeof(field),tgid), sizeof(field.tgid), (((unsigned int)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ((void)(sizeof(struct { int:-!!(8 > 256); }))); ret = trace_define_field(event_call, "unsigned long" "[" "FTRACE_STACK_ENTRIES" "]", "caller", __builtin_offsetof(typeof(field),caller), sizeof(field.caller), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret;; return ret; }
# 205 "kernel/trace/trace_entries.h"
 ;
...
int
# 222 "kernel/trace/trace_entries.h"
 ftrace_define_fields_bprint
# 210 "kernel/trace/trace_entries.h"
 (struct ftrace_event_call *event_call) { struct bprint_entry field; int ret; ret = trace_define_field(event_call, "unsigned long", "ip", __builtin_offsetof(typeof(field),ip), sizeof(field.ip), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "const char *", "fmt", __builtin_offsetof(typeof(field),fmt), sizeof(field.fmt), (((const char *)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "u32", "buf", __builtin_offsetof(typeof(field),buf), 0, (((u32)(-1)) < 0), FILTER_OTHER); if (ret) return ret;; return ret; }
# 222 "kernel/trace/trace_entries.h"
 ;

int
# 235 "kernel/trace/trace_entries.h"
 ftrace_define_fields_print
# 224 "kernel/trace/trace_entries.h"
 (struct ftrace_event_call *event_call) { struct print_entry field; int ret; ret = trace_define_field(event_call, "unsigned long", "ip", __builtin_offsetof(typeof(field),ip), sizeof(field.ip), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "char", "buf", __builtin_offsetof(typeof(field),buf), 0, (((char)(-1)) < 0), FILTER_OTHER); if (ret) return ret;; return ret; }
# 235 "kernel/trace/trace_entries.h"
 ;

int
# 254 "kernel/trace/trace_entries.h"
 ftrace_define_fields_mmiotrace_rw
# 237 "kernel/trace/trace_entries.h"
 (struct ftrace_event_call *event_call) { struct trace_mmiotrace_rw field; int ret; ret = trace_define_field(event_call, "resource_size_t", "phys", __builtin_offsetof(typeof(field),rw.phys), sizeof(field.rw.phys), (((resource_size_t)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned long", "value", __builtin_offsetof(typeof(field),rw.value), sizeof(field.rw.value), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned long", "pc", __builtin_offsetof(typeof(field),rw.pc), sizeof(field.rw.pc), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "int", "map_id", __builtin_offsetof(typeof(field),rw.map_id), sizeof(field.rw.map_id), (((int)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned char", "opcode", __builtin_offsetof(typeof(field),rw.opcode), sizeof(field.rw.opcode), (((unsigned char)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned char", "width", __builtin_offsetof(typeof(field),rw.width), sizeof(field.rw.width), (((unsigned char)(-1)) < 0), FILTER_OTHER); if (ret) return ret;; return ret; }
# 254 "kernel/trace/trace_entries.h"
 ;

int
# 272 "kernel/trace/trace_entries.h"
 ftrace_define_fields_mmiotrace_map
# 256 "kernel/trace/trace_entries.h"
 (struct ftrace_event_call *event_call) { struct trace_mmiotrace_map field; int ret; ret = trace_define_field(event_call, "resource_size_t", "phys", __builtin_offsetof(typeof(field),map.phys), sizeof(field.map.phys), (((resource_size_t)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned long", "virt", __builtin_offsetof(typeof(field),map.virt), sizeof(field.map.virt), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned long", "len", __builtin_offsetof(typeof(field),map.len), sizeof(field.map.len), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "int", "map_id", __builtin_offsetof(typeof(field),map.map_id), sizeof(field.map.map_id), (((int)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned char", "opcode", __builtin_offsetof(typeof(field),map.opcode), sizeof(field.map.opcode), (((unsigned char)(-1)) < 0), FILTER_OTHER); if (ret) return ret;; return ret; }
# 272 "kernel/trace/trace_entries.h"
 ;

int
# 285 "kernel/trace/trace_entries.h"
 ftrace_define_fields_boot_call
# 274 "kernel/trace/trace_entries.h"
 (struct ftrace_event_call *event_call) { struct trace_boot_call field; int ret; ret = trace_define_field(event_call, "pid_t", "caller", __builtin_offsetof(typeof(field),boot_call.caller), sizeof(field.boot_call.caller), (((pid_t)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ((void)(sizeof(struct { int:-!!((sizeof("%s+%#lx/%#lx [%s]") + (128 - 1) + 2*(64*3/10) + ((64 - sizeof(unsigned long)) - 1) + 1) > 256); }))); ret = trace_define_field(event_call, "char" "[" "KSYM_SYMBOL_LEN" "]", "func", __builtin_offsetof(typeof(field),boot_call.func), sizeof(field.boot_call.func), (((char)(-1)) < 0), FILTER_OTHER); if (ret) return ret;; return ret; }
# 285 "kernel/trace/trace_entries.h"
 ;

int
# 300 "kernel/trace/trace_entries.h"
 ftrace_define_fields_boot_ret
# 287 "kernel/trace/trace_entries.h"
 (struct ftrace_event_call *event_call) { struct trace_boot_ret field; int ret; ((void)(sizeof(struct { int:-!!((sizeof("%s+%#lx/%#lx [%s]") + (128 - 1) + 2*(64*3/10) + ((64 - sizeof(unsigned long)) - 1) + 1) > 256); }))); ret = trace_define_field(event_call, "char" "[" "KSYM_SYMBOL_LEN" "]", "func", __builtin_offsetof(typeof(field),boot_ret.func), sizeof(field.boot_ret.func), (((char)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "int", "result", __builtin_offsetof(typeof(field),boot_ret.result), sizeof(field.boot_ret.result), (((int)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned long", "duration", __builtin_offsetof(typeof(field),boot_ret.duration), sizeof(field.boot_ret.duration), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret;; return ret; }
# 300 "kernel/trace/trace_entries.h"
 ;
...
int
# 319 "kernel/trace/trace_entries.h"
 ftrace_define_fields_branch
# 305 "kernel/trace/trace_entries.h"
 (struct ftrace_event_call *event_call) { struct trace_branch field; int ret; ret = trace_define_field(event_call, "unsigned int", "line", __builtin_offsetof(typeof(field),line), sizeof(field.line), (((unsigned int)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ((void)(sizeof(struct { int:-!!(30 +1 > 256); }))); ret = trace_define_field(event_call, "char" "[" "TRACE_FUNC_SIZE+1" "]", "func", __builtin_offsetof(typeof(field),func), sizeof(field.func), (((char)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ((void)(sizeof(struct { int:-!!(20 +1 > 256); }))); ret = trace_define_field(event_call, "char" "[" "TRACE_FILE_SIZE+1" "]", "file", __builtin_offsetof(typeof(field),file), sizeof(field.file), (((char)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "char", "correct", __builtin_offsetof(typeof(field),correct), sizeof(field.correct), (((char)(-1)) < 0), FILTER_OTHER); if (ret) return ret;; return ret; }
# 319 "kernel/trace/trace_entries.h"
 ;

int
# 340 "kernel/trace/trace_entries.h"
 ftrace_define_fields_kmem_alloc
# 321 "kernel/trace/trace_entries.h"
 (struct ftrace_event_call *event_call) { struct kmemtrace_alloc_entry field; int ret; ret = trace_define_field(event_call, "enum kmemtrace_type_id", "type_id", __builtin_offsetof(typeof(field),type_id), sizeof(field.type_id), (((enum kmemtrace_type_id)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned long", "call_site", __builtin_offsetof(typeof(field),call_site), sizeof(field.call_site), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "const void *", "ptr", __builtin_offsetof(typeof(field),ptr), sizeof(field.ptr), (((const void *)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "size_t", "bytes_req", __builtin_offsetof(typeof(field),bytes_req), sizeof(field.bytes_req), (((size_t)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "size_t", "bytes_alloc", __builtin_offsetof(typeof(field),bytes_alloc), sizeof(field.bytes_alloc), (((size_t)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "gfp_t", "gfp_flags", __builtin_offsetof(typeof(field),gfp_flags), sizeof(field.gfp_flags), (((gfp_t)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "int", "node", __builtin_offsetof(typeof(field),node), sizeof(field.node), (((int)(-1)) < 0), FILTER_OTHER); if (ret) return ret;; return ret; }
# 340 "kernel/trace/trace_entries.h"
 ;

int
# 354 "kernel/trace/trace_entries.h"
 ftrace_define_fields_kmem_free
# 342 "kernel/trace/trace_entries.h"
 (struct ftrace_event_call *event_call) { struct kmemtrace_free_entry field; int ret; ret = trace_define_field(event_call, "enum kmemtrace_type_id", "type_id", __builtin_offsetof(typeof(field),type_id), sizeof(field.type_id), (((enum kmemtrace_type_id)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned long", "call_site", __builtin_offsetof(typeof(field),call_site), sizeof(field.call_site), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "const void *", "ptr", __builtin_offsetof(typeof(field),ptr), sizeof(field.ptr), (((const void *)(-1)) < 0), FILTER_OTHER); if (ret) return ret;; return ret; }
# 354 "kernel/trace/trace_entries.h"
 ;

int
# 370 "kernel/trace/trace_entries.h"
 ftrace_define_fields_ksym_trace
# 356 "kernel/trace/trace_entries.h"
 (struct ftrace_event_call *event_call) { struct ksym_trace_entry field; int ret; ret = trace_define_field(event_call, "unsigned long", "ip", __builtin_offsetof(typeof(field),ip), sizeof(field.ip), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned char", "type", __builtin_offsetof(typeof(field),type), sizeof(field.type), (((unsigned char)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ((void)(sizeof(struct { int:-!!(16 > 256); }))); ret = trace_define_field(event_call, "char" "[" "TASK_COMM_LEN" "]", "cmd", __builtin_offsetof(typeof(field),cmd), sizeof(field.cmd), (((char)(-1)) < 0), FILTER_OTHER); if (ret) return ret; ret = trace_define_field(event_call, "unsigned long", "addr", __builtin_offsetof(typeof(field),addr), sizeof(field.addr), (((unsigned long)(-1)) < 0), FILTER_OTHER); if (ret) return ret;; return ret; }
# 370 "kernel/trace/trace_entries.h"
 ;
# 127 "kernel/trace/trace_export.c" 2
...
# 173 "kernel/trace/trace_export.c"
# 1 "kernel/trace/trace_entries.h" 1
# 58 "kernel/trace/trace_entries.h"
struct ftrace_event_class
# 68 "kernel/trace/trace_entries.h"
 event_class_ftrace_function
# 58 "kernel/trace/trace_entries.h"
 = { .system = "ftrace", .define_fields =
# 68 "kernel/trace/trace_entries.h"
 ftrace_define_fields_function
# 58 "kernel/trace/trace_entries.h"
 , .raw_init = ftrace_raw_init_event, };

struct ftrace_event_call event_function = {
        .name = "function",
        .event.type = TRACE_FN,
        .class = &event_class_ftrace_function,
        .print_fmt = "\" %lx <-- %lx\"" ", " "REC->ip, REC->parent_ip",
};
...
# 82 "kernel/trace/trace_entries.h"
 ftrace_define_fields_funcgraph_entry
# 71 "kernel/trace/trace_entries.h"
 , .raw_init = ftrace_raw_init_event, }; struct ftrace_event_call __attribute__((__used__)) __attribute__((__aligned__(4))) __attribute__((section("_ftrace_events")))
# 82 "kernel/trace/trace_entries.h"
 event_funcgraph_entry
# 71 "kernel/trace/trace_entries.h"
 = { .name = "funcgraph_entry", .event.type = TRACE_GRAPH_ENT, .class = &
# 82 "kernel/trace/trace_entries.h"
 event_class_ftrace_funcgraph_entry
# 71 "kernel/trace/trace_entries.h"
 , .print_fmt = "\"--> %lx (%d)\"" ", " "REC->func, REC->depth", };
# 82 "kernel/trace/trace_entries.h"
 ;
...
# 102 "kernel/trace/trace_entries.h"
 event_funcgraph_exit
# 85 "kernel/trace/trace_entries.h"
 = { .name = "funcgraph_exit", .event.type = TRACE_GRAPH_RET, .class = &
# 102 "kernel/trace/trace_entries.h"
 event_class_ftrace_funcgraph_exit
# 85 "kernel/trace/trace_entries.h"
 , .print_fmt = "\"<-- %lx (%d) (start: %llx  end: %llx) over: %d\"" ", " "REC->func, REC->depth, REC->calltime, REC->rettime, REC->depth", };
# 102 "kernel/trace/trace_entries.h"
 ;
# 119 "kernel/trace/trace_entries.h"
struct ftrace_event_class
...
# 132 "kernel/trace/trace_entries.h"
 event_context_switch
# 119 "kernel/trace/trace_entries.h"
 = { .name = "context_switch", .event.type = TRACE_CTX, .class = &
# 132 "kernel/trace/trace_entries.h"
 event_class_ftrace_context_switch
# 119 "kernel/trace/trace_entries.h"
 , .print_fmt = "\"%u:%u:%u  ==> %u:%u:%u [%03u]\"" ", " "REC->prev_pid, REC->prev_prio, REC->prev_state, REC->next_pid, REC->next_prio, REC->next_state, REC->next_cpu", };
# 132 "kernel/trace/trace_entries.h"
 ;
...
# 151 "kernel/trace/trace_entries.h"
 event_wakeup
# 138 "kernel/trace/trace_entries.h"
 = { .name = "wakeup", .event.type = TRACE_WAKE, .class = &
# 151 "kernel/trace/trace_entries.h"
 event_class_ftrace_wakeup
# 138 "kernel/trace/trace_entries.h"
 , .print_fmt = "\"%u:%u:%u  ==+ %u:%u:%u [%03u]\"" ", " "REC->prev_pid, REC->prev_prio, REC->prev_state, REC->next_pid, REC->next_prio, REC->next_state, REC->next_cpu", };
...
# 168 "kernel/trace/trace_entries.h"
 event_special
# 156 "kernel/trace/trace_entries.h"
 = { .name = "special", .event.type = TRACE_SPECIAL, .class = &
# 168 "kernel/trace/trace_entries.h"
 event_class_ftrace_special
# 156 "kernel/trace/trace_entries.h"
 , .print_fmt = "\"(%08lx) (%08lx) (%08lx)\"" ", " "REC->arg1, REC->arg2, REC->arg3", };
# 168 "kernel/trace/trace_entries.h"
 ;
...
struct ftrace_event_call event_kernel_stack = {
         .name = "kernel_stack",
         .event.type = TRACE_STACK,
         .class = &event_class_ftrace_kernel_stack,
         .print_fmt = "\"\\t=> (%08lx)\\n\\t=> (%08lx)\\n\\t=> (%08lx)\\n\\t=> (%08lx)\\n\" \"\\t=> (%08lx)\\n\\t=> (%08lx)\\n\\t=> (%08lx)\\n\\t=> (%08lx)\\n\"" ", " "REC->caller[0], REC->caller[1], REC->caller[2], REC->caller[3], REC->caller[4], REC->caller[5], REC->caller[6], REC->caller[7]",
};

struct ftrace_event_class
# 205 "kernel/trace/trace_entries.h"
 event_class_ftrace_user_stack
# 191 "kernel/trace/trace_entries.h"
 = { .system = "ftrace", .define_fields =
# 205 "kernel/trace/trace_entries.h"
 ftrace_define_fields_user_stack
...
# 205 "kernel/trace/trace_entries.h"
 event_user_stack
# 191 "kernel/trace/trace_entries.h"
 = { .name = "user_stack", .event.type = TRACE_USER_STACK, .class = &
# 205 "kernel/trace/trace_entries.h"
 event_class_ftrace_user_stack
# 191 "kernel/trace/trace_entries.h"
 , .print_fmt = "\"\\t=> (%08lx)\\n\\t=> (%08lx)\\n\\t=> (%08lx)\\n\\t=> (%08lx)\\n\" \"\\t=> (%08lx)\\n\\t=> (%08lx)\\n\\t=> (%08lx)\\n\\t=> (%08lx)\\n\"" ", " "REC->caller[0], REC->caller[1], REC->caller[2], REC->caller[3], REC->caller[4], REC->caller[5], REC->caller[6], REC->caller[7]", };
...
# 222 "kernel/trace/trace_entries.h"
 event_bprint
# 210 "kernel/trace/trace_entries.h"
 = { .name = "bprint", .event.type = TRACE_BPRINT, .class = &
# 222 "kernel/trace/trace_entries.h"
 event_class_ftrace_bprint
# 210 "kernel/trace/trace_entries.h"
 , .print_fmt = "\"%08lx fmt:%p\"" ", " "REC->ip, REC->fmt", };
# 222 "kernel/trace/trace_entries.h"
 ;
...
# 235 "kernel/trace/trace_entries.h"
 event_print
# 224 "kernel/trace/trace_entries.h"
 = { .name = "print", .event.type = TRACE_PRINT, .class = &
# 235 "kernel/trace/trace_entries.h"
 event_class_ftrace_print
# 224 "kernel/trace/trace_entries.h"
 , .print_fmt = "\"%08lx %s\"" ", " "REC->ip, REC->buf", };
# 235 "kernel/trace/trace_entries.h"
 ;

struct ftrace_event_class
# 254 "kernel/trace/trace_entries.h"
 event_class_ftrace_mmiotrace_rw
# 237 "kernel/trace/trace_entries.h"
 = { .system = "ftrace", .define_fields =
# 254 "kernel/trace/trace_entries.h"
 ftrace_define_fields_mmiotrace_rw
...
# 254 "kernel/trace/trace_entries.h"
 event_mmiotrace_rw
# 237 "kernel/trace/trace_entries.h"
 = { .name = "mmiotrace_rw", .event.type = TRACE_MMIO_RW, .class = &
# 254 "kernel/trace/trace_entries.h"
 event_class_ftrace_mmiotrace_rw
# 237 "kernel/trace/trace_entries.h"
 , .print_fmt = "\"%lx %lx %lx %d %x %x\"" ", " "(unsigned long)REC->phys, REC->value, REC->pc, REC->map_id, REC->opcode, REC->width", };
# 254 "kernel/trace/trace_entries.h"
 ;

struct ftrace_event_class
# 272 "kernel/trace/trace_entries.h"
 event_class_ftrace_mmiotrace_map
# 256 "kernel/trace/trace_entries.h"
 = { .system = "ftrace", .define_fields =
# 272 "kernel/trace/trace_entries.h"
 ftrace_define_fields_mmiotrace_map
...
# 272 "kernel/trace/trace_entries.h"
 event_mmiotrace_map
# 256 "kernel/trace/trace_entries.h"
 = { .name = "mmiotrace_map", .event.type = TRACE_MMIO_MAP, .class = &
# 272 "kernel/trace/trace_entries.h"
 event_class_ftrace_mmiotrace_map
# 256 "kernel/trace/trace_entries.h"
 , .print_fmt = "\"%lx %lx %lx %d %x\"" ", " "(unsigned long)REC->phys, REC->virt, REC->len, REC->map_id, REC->opcode", };
# 272 "kernel/trace/trace_entries.h"
 ;

struct ftrace_event_class
# 285 "kernel/trace/trace_entries.h"
 event_class_ftrace_boot_call
# 274 "kernel/trace/trace_entries.h"
 = { .system = "ftrace", .define_fields =
# 285 "kernel/trace/trace_entries.h"
 ftrace_define_fields_boot_call
...
# 285 "kernel/trace/trace_entries.h"
 event_boot_call
# 274 "kernel/trace/trace_entries.h"
 = { .name = "boot_call", .event.type = TRACE_BOOT_CALL, .class = &
# 285 "kernel/trace/trace_entries.h"
 event_class_ftrace_boot_call
# 274 "kernel/trace/trace_entries.h"
 , .print_fmt = "\"%d  %s\"" ", " "REC->caller, REC->func", };
# 285 "kernel/trace/trace_entries.h"
 ;

struct ftrace_event_class
# 300 "kernel/trace/trace_entries.h"
 event_class_ftrace_boot_ret
# 287 "kernel/trace/trace_entries.h"
 = { .system = "ftrace", .define_fields =
# 300 "kernel/trace/trace_entries.h"
 ftrace_define_fields_boot_ret
...
# 300 "kernel/trace/trace_entries.h"
 event_boot_ret
# 287 "kernel/trace/trace_entries.h"
 = { .name = "boot_ret", .event.type = TRACE_BOOT_RET, .class = &
# 300 "kernel/trace/trace_entries.h"
 event_class_ftrace_boot_ret
# 287 "kernel/trace/trace_entries.h"
 , .print_fmt = "\"%s %d %lx\"" ", " "REC->func, REC->result, REC->duration", };
# 300 "kernel/trace/trace_entries.h"
 ;
...
# 319 "kernel/trace/trace_entries.h"
 event_branch
# 305 "kernel/trace/trace_entries.h"
 = { .name = "branch", .event.type = TRACE_BRANCH, .class = &
# 319 "kernel/trace/trace_entries.h"
 event_class_ftrace_branch
# 305 "kernel/trace/trace_entries.h"
 , .print_fmt = "\"%u:%s:%s (%u)\"" ", " "REC->line, REC->func, REC->file, REC->correct", };
# 319 "kernel/trace/trace_entries.h"
 ;

struct ftrace_event_class
# 340 "kernel/trace/trace_entries.h"
 event_class_ftrace_kmem_alloc
# 321 "kernel/trace/trace_entries.h"
 = { .system = "ftrace", .define_fields =
# 340 "kernel/trace/trace_entries.h"
 ftrace_define_fields_kmem_alloc
...
# 340 "kernel/trace/trace_entries.h"
 event_kmem_alloc
# 321 "kernel/trace/trace_entries.h"
 = { .name = "kmem_alloc", .event.type = TRACE_KMEM_ALLOC, .class = &
# 340 "kernel/trace/trace_entries.h"
 event_class_ftrace_kmem_alloc
# 321 "kernel/trace/trace_entries.h"
 , .print_fmt = "\"type:%u call_site:%lx ptr:%p req:%zi alloc:%zi\" \" flags:%x node:%d\"" ", " "REC->type_id, REC->call_site, REC->ptr, REC->bytes_req, REC->bytes_alloc, REC->gfp_flags, REC->node", };
# 340 "kernel/trace/trace_entries.h"
 ;

struct ftrace_event_class
# 354 "kernel/trace/trace_entries.h"
 event_class_ftrace_kmem_free
# 342 "kernel/trace/trace_entries.h"
 = { .system = "ftrace", .define_fields =
# 354 "kernel/trace/trace_entries.h"
 ftrace_define_fields_kmem_free
...
# 354 "kernel/trace/trace_entries.h"
 event_kmem_free
# 342 "kernel/trace/trace_entries.h"
 = { .name = "kmem_free", .event.type = TRACE_KMEM_FREE, .class = &
# 354 "kernel/trace/trace_entries.h"
 event_class_ftrace_kmem_free
# 342 "kernel/trace/trace_entries.h"
 , .print_fmt = "\"type:%u call_site:%lx ptr:%p\"" ", " "REC->type_id, REC->call_site, REC->ptr", };
# 354 "kernel/trace/trace_entries.h"
 ;

struct ftrace_event_class
# 370 "kernel/trace/trace_entries.h"
 event_class_ftrace_ksym_trace
# 356 "kernel/trace/trace_entries.h"
 = { .system = "ftrace", .define_fields =
# 370 "kernel/trace/trace_entries.h"
 ftrace_define_fields_ksym_trace
...
# 370 "kernel/trace/trace_entries.h"
 event_ksym_trace
# 356 "kernel/trace/trace_entries.h"
 = { .name = "ksym_trace", .event.type = TRACE_KSYM, .class = &
# 370 "kernel/trace/trace_entries.h"
 event_class_ftrace_ksym_trace
# 356 "kernel/trace/trace_entries.h"
 , .print_fmt = "\"ip: %pF type: %d ksym_name: %pS cmd: %s\"" ", " "(void *)REC->ip, (unsigned int)REC->type, (void *)REC->addr, REC->cmd", };
# 370 "kernel/trace/trace_entries.h"
 ;
# 173 "kernel/trace/trace_export.c" 2
