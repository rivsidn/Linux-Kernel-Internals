...
# 6 "kernel/trace/trace_stack.c" 2
...
# 7 "kernel/trace/trace_stack.c" 2
...
extern struct hlist_node *seq_hlist_next_rcu(void *v,
         ...
         loff_t *ppos);
# 8 "kernel/trace/trace_stack.c" 2
...
# 9 "kernel/trace/trace_stack.c" 2
...
# 10 "kernel/trace/trace_stack.c" 2
...
# 11 "kernel/trace/trace_stack.c" 2
...
# 12 "kernel/trace/trace_stack.c" 2
...
# 17 "kernel/trace/trace_stack.c" 2



static unsigned long stack_dump_trace[500 +1] =
  { [0 ... (500)] = (~0UL) };
static unsigned stack_dump_index[500];
...
static int stack_trace_disabled __attribute__((__section__(".data..read_mostly")));
static __attribute__((section(".data..percpu" ""))) __typeof__(int) trace_active;
static struct mutex stack_sysctl_mutex = { .count = { (1) } , .wait_lock = (spinlock_t ) { { .rlock = { .raw_lock = { 0 }, .magic = 0xdead4ead, .owner_cpu = -1, .owner = ((void *)-1L), .dep_map = { .name = "stack_sysctl_mutex.wait_lock" } } } } , .wait_list = { &(stack_sysctl_mutex.wait_list), &(stack_sysctl_mutex.wait_list) } , .magic = &stack_sysctl_mutex , .dep_map = { .name = "stack_sysctl_mutex" } };

int stack_tracer_enabled;
static int last_stack_tracer_enabled;

static inline __attribute__((always_inline)) void check_stack(void)
{
 unsigned long this_size, flags;
 unsigned long *p, *top, *start;
 int i;

 this_size = ((unsigned long)&this_size) & ((((1UL) << 12) << 1)-1);
 this_size = (((1UL) << 12) << 1) - this_size;
 ...
 start = &this_size;
 top = (unsigned long *)
  (((unsigned long)start & ~((((1UL) << 12) << 1)-1)) + (((1UL) << 12) << 1));
# 85 "kernel/trace/trace_stack.c"
...
stack_trace_call(unsigned long ip, unsigned long parent_ip)
{
 ...
 if (__builtin_expect(!!(!ftrace_enabled || stack_trace_disabled), 0))
  return;
 ...
 if ((*({ do { const void *__vpp_verify = (typeof((&(trace_active))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(trace_active))) *)(&(trace_active)))); (typeof((typeof(*(&(trace_active))) *)(&(trace_active)))) (__ptr + (((__per_cpu_offset[cpu])))); }); }))++ != 0)
  goto out;

 check_stack();

 out:
 (*({ do { const void *__vpp_verify = (typeof((&(trace_active))))((void *)0); (void)__vpp_verify; } while (0); ({ unsigned long __ptr; __asm__ ("" : "=r"(__ptr) : "0"((typeof(*(&(trace_active))) *)(&(trace_active)))); (typeof((typeof(*(&(trace_active))) *)(&(trace_active)))) (__ptr + (((__per_cpu_offset[cpu])))); }); }))--;

 ftrace_preempt_enable(resched);
}

static struct ftrace_ops trace_ops __attribute__((__section__(".data..read_mostly"))) =
{
 .func = stack_trace_call,
};

static ssize_t
stack_max_size_read(struct file *filp, char *ubuf,
...
static ssize_t
stack_max_size_write(struct file *filp, const char *ubuf,
       size_t count, loff_t *ppos)
{
...
__next(struct seq_file *m, loff_t *pos)
{
 ...
 if (n >= max_stack_trace.nr_entries || stack_dump_trace[n] == (~0UL))
  return ((void *)0);
...
static int t_show(struct seq_file *m, void *v)
{
 ...
 if (i >= max_stack_trace.nr_entries ||
     stack_dump_trace[i] == (~0UL))
  return 0;

 if (i+1 == max_stack_trace.nr_entries ||
     stack_dump_trace[i+1] == (~0UL))
     ...
     loff_t *ppos)
{
 ...
 mutex_lock_nested(&stack_sysctl_mutex, 0);
...
static __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) int enable_stacktrace(char *str)
{
 stack_tracer_enabled = 1;
 last_stack_tracer_enabled = 1;
 return 1;
}
static const char __setup_str_enable_stacktrace[] __attribute__ ((__section__(".init.rodata"))) __attribute__((aligned(1))) = "stacktrace"; static struct obs_kernel_param __setup_enable_stacktrace __attribute__((__used__)) __attribute__ ((__section__(".init.setup"))) __attribute__((aligned((sizeof(long))))) = { __setup_str_enable_stacktrace, enable_stacktrace, 0 };

static __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) __attribute__((no_instrument_function)) int stack_trace_init(void)
{
...
static initcall_t __initcall_stack_trace_init6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init"))) = stack_trace_init;
